...
<html>
  ...
  <body>
    <div class="thanh-ton-thnh-cng">
      <div class="frame10">
        <img class="bg-icon2" alt="" src="./public/bg1.svg" />

        <div class="khung-cha-v1">
          <img class="group-icon19" alt="" src="./public/group7.svg" />
          ...
          <div class="v-1">
            <div class="v-11">
              ...
              <div class="ngy-s-dng2">Ngày sử dụng: 31/05/2021</div>
              <b class="b3">---</b>
        ...
        <div class="btn-xem-chi-tit4">
          ...
          <div class="xem-chi-tit-btn4">
            <img class="group-icon20" alt="" src="./public/group10.svg" />
      ...
      <div class="navigation3">
        ...
        <div class="frame-parent16">
          ...
          <div class="group-parent8">
            <img class="group-icon22" alt="" src="./public/group4.svg" />
